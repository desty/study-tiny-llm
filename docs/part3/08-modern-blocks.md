...
<a class="colab-badge" href="https://colab.research.google.com/github/desty/study-tiny-llm/blob/main/notebooks/part3/ch08_modern_blocks.ipynb" target="_blank">
...
!!! quote "전제"
    [Ch 7 Attention](07-attention.md) 의 Q·K·V 를 머리에 그릴 수 있어야. LayerNorm·GeLU 도 한 번 들어본 상태.
