# Data Pipeline — PII, Synthetic, IAA
...
!!! abstract "What you'll learn"
    - PII masking on call transcripts, LLM-synthesized labels, a tiny inter-annotator agreement check. The step that makes training data trustworthy.
